...
namespace Software64.Chessmen.UnitTest
{
    ...
    class QueenTest
    {
        ...
        public void MoveTo_should_ignore_squares_that_are_not_allowed()
        {
            ...
            ChessmenBase queen = new Queen(Color.Black, currentSquare);

            // Act
            queen.MoveTo(targetSquare);

            // Assert
            Assert.That(queen.Square, Is.EqualTo(currentSquare));
        }
        ...
        public void MoveTo_should_set_square_to_target_square()
        {
            ...
            // Assert
            Assert.That(queen.Square, Is.EqualTo(targetSquare));
        }
        ...
        public void CanMoveTo_should_return_true_when_target_square_is_valid()
        {
            ...
            // Act
            var result = queen.CanMoveTo(targetSquare);
